...
export function SidebarHeading({ className, ...props }: React.ComponentPropsWithoutRef<'h3'>) {
  return <h3 {...props} className={clsx(className, 'mb-1 px-2 text-xs/6 font-medium text-text-secondary')} />
}
...
export const SidebarItem = forwardRef(function SidebarItem(
  {
    ...
    | ({ href?: never } & Omit<Headless.ButtonProps, 'as' | 'className' | 'href'>)
    | ({ href: string } & Omit<Headless.ButtonProps<typeof Link>, 'as' | 'className' | 'href'>)
  ),
