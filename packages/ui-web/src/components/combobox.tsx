    ...
    <Headless.Combobox {...props} multiple={false} virtual={{ options: filteredOptions }} onClose={() => setQuery('')}>
      <span
        ...
        className={clsx([
          ...
          // Focus ring
          'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-focus',
          // Disabled state
          'has-data-disabled:opacity-50 has-data-disabled:before:bg-text-primary/5 has-data-disabled:before:shadow-none',
          // Invalid state
      ...
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            ...
            // Disabled state
            'data-disabled:border-border data-disabled:bg-surface-2',
          ])}
        />
        <Headless.ComboboxButton className="group absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="size-5 stroke-text-muted group-data-hover:stroke-text-secondary group-data-disabled:stroke-text-muted sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
